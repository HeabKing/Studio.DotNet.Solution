...
namespace Studio.DotNet.Bll
{
    ...
    public class ArticleBll : IBll.IAritlceBll
    {
		...
		public ArticleBll(IDal.ITblArticleDal articleDal, IDal.ITblTagDal tagDal, IDal.ITblArticleTblTagDal articleTagDal, IDal.ITblUserTblArticleDal userArticleDal)
		{
	    ...
	    public async Task<int> AddAsync(TblArticle article, IEnumerable<TblTag> tags, int userId)
	    {
			...
			foreach (var tag in tagWithValues)
			{
				...
				{
					tagWithIds.Add(new TblTag { Id = tag.Id });
				}
			}
